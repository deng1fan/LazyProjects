...
class ModelNet(BasePLModel):
    ...
    def print_model_introduction(self):
        ...
        console.print("[bold green]     input_ids<sep>labels")
        console.print("[bold green]")
        console.print("[bold green]               \u25B2")
        console.print(
            "[bold green]               \u2502            \u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510")
        console.print(
            "[bold green]               \u251C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2502 CrossEntropyLoss  \u2502")
        console.print(
            "[bold green]               \u2502            \u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518")
        console.print("[bold green]               \u25BC")
        console.print("[bold green]")
        console.print("[bold green] input_ids<sep>generated_ids")
        console.print("[bold green]")
        console.print("[bold green]               \u25B2")
        console.print("[bold green]               \u2502")
        console.print("[bold green]               \u2502")
        console.print("[bold green]        \u250C\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2510")
        console.print("[bold green]        \u2502             \u2502")
        console.print("[bold green]        \u2502   Decoder   \u2502")
        console.print("[bold green]        \u2502             \u2502")
        console.print("[bold green]        \u2514\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2518")
        console.print("[bold green]               \u25B2")
        console.print("[bold green]               \u2502")
        console.print("[bold green]               \u2502")
        console.print("[bold green]")
        console.print("[bold green]  <bos>input_ids<sep>labels")
        console.print("[bold cyan]")
        console.print("[bold cyan]注意：", justify='center')
        console.print("[bold cyan]1. 极其简单的HuggingFace Decoder模型，暂不支持Copy机制，不支持分类任务", justify='center')
        console.print("[bold cyan]2. 最普通的Decoder架构，输入没有经过任何处理直接送进模型，得到输出", justify='center')
        console.print("[bold]························································", justify='center')
        pass
